    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
       <div>
          ...
          <div className="mt-4 p-5 bg-white border border-slate-200 rounded-2xl shadow-sm grid grid-cols-2 md:grid-cols-4 gap-6 relative overflow-hidden">
             ...
             {/* Latar Belakang Lunas Watermark */}
             ...
             <div className="flex flex-col md:text-right relative z-10">
               ...
               <span className={`font-bold text-xs px-2 py-0.5 rounded w-fit md:ml-auto mt-1 uppercase tracking-widest border ${
                  shipment?.payment_status_code === 'PAID' ? 'bg-emerald-100 text-emerald-800 border-emerald-200' :
                  shipment?.payment_status_code === 'PARTIAL' ? 'bg-blue-100 text-blue-800 border-blue-200' :
