-- WarekCargo PostgreSQL Schema v2
-- ERP-lite foundation for customer intake, hub package tracking, batch shipping,
-- consolidated shipment handling, payment tracking, and file metadata storage.
